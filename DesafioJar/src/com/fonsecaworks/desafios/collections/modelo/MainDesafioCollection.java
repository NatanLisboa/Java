...
/**
 * Classe principal (main), a qual roda o programa para calcular o salário dos políticos brasileiros de partidos fictícios
 * @author Natan da Fonseca Lisboa
 */
public class MainDesafioCollection {

	/**
	 * Método principal que contém instâncias para realizar o cálculo do salário de políticos
	 * 
